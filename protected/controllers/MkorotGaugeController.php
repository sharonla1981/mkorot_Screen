	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','getGaugeOptionsAjax','getAreaOptionsAjax','getGaugeAreaIdOptionsAjax'),
				'users'=>array('@'),
			),
...
*/
    ...
    public function actionGetGaugeAreaIdOptionsAjax()
    {
        if(Yii::app()->request->isAjaxRequest && isset($_GET['term1']))
        {
            ...
            $criteria->addSearchCondition('id',  strtoupper( $_GET['term']) ) ;
            $criteria->limit = 15;
            $criteria->compare('id',$_GET['term1']);
            ...
            foreach ($data as $item) {
                ...
                $data = AreaGauge::model()->findByPk($_GET['term1'])->getAttribute('areaId');
